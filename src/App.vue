				...
				<div class="mcp-modal-body">
					...
					<NcNoteCard v-else-if="summaryText" type="info" class="mcp-summary">
						...
						<p class="mcp-summary-provenance">
							<!-- Which tier answered: a page-reading summary and a
								 text-only one are different claims about the document. -->
							{{ summaryMode === 'analyze-images'
								? t('astrolabe', 'Generated by reading the document pages.')
								: t('astrolabe', 'Generated from extracted text, so layout and images were not read.') }}
						</p>
					</NcNoteCard>
...
export default {
	...
	methods: {
		...
		/**
		 * Ask the backend to summarize the document currently open in the viewer.
		 *
