...
export default function DocsLayout({
  ...
  return (
    <Container size="lg" className="py-16 sm:py-20">
      <article className="prose prose-slate max-w-3xl prose-headings:tracking-tight prose-a:font-medium prose-a:text-brand-600 prose-a:no-underline hover:prose-a:text-brand-700 prose-code:rounded prose-code:bg-slate-100 prose-code:px-1.5 prose-code:py-0.5 prose-code:font-normal prose-code:before:content-[''] prose-code:after:content-['']">
        {children}
      </article>
    </Container>
  );
