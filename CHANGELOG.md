...
- **deps**: update next monorepo to v16.3.5
...
- **deps**: update next monorepo to v16.3.4
...
- **deps**: update next monorepo to v16.3.2

## v0.42.3 (2026-08-18)

### Fix

- **examples**: create the authentik .env owner-only too

## v0.42.2 (2026-08-17)

### Fix

- **auth**: resolve IdP-app enablement against the target user
- **auth**: support an external IdP for per-user MCP tokens

## v0.42.1 (2026-08-17)

### Fix

- **deps**: update next monorepo to v16.3.1
...
- **deps**: update next monorepo to v16.3.0
...
- **deps**: update next monorepo to v16.2.12
...
- **deps**: update dependency cweagans/composer-patches to v2
...
- **assistant**: guard composer's autoloader against double inclusion
- **assistant**: keep agent conversations working on MySQL and in the package
...
- declare Nextcloud 34 compatibility

## v0.36.0 (2026-07-10)

### Feat

- document keyword-index tag; retire stale keyword-only-mode wording
...
- **deps**: update next monorepo to v16.2.10
...
- **search**: add mail_message doc_type to the search source catalog

## v0.30.2 (2026-06-20)

### Fix

- **ui**: use --color-success-text for filled status badges
